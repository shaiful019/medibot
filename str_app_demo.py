...
# Set OpenAI API key
os.environ["OPENAI_API_KEY"] = "sk-proj-HdKg1mZPgxnkBMizAnEBT3BlbkFJI5HFbfVqzOPG5TMLU7yp"

# Custom CSS to change header color
# svg_path = 'logo.svg'
# st.image(svg_path, width=200)
custom_css = """
<h style="font-size:44px; color: #50BFE6">Extract knowledge through SeaBOT</h>
"""
